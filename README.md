...
## Few Shot Classification Evaluations on our data
...
EXAMPLE for running evaluation on our FS CUB dataset:
```bash
...
#### questions prompt used for FS classification evaluation:
```bash
...
```
## Few Shot Classification Evaluations on YOUR data
